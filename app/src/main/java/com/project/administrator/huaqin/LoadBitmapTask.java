...
//        };
        ...
        mPortraitBGs = new int[]{R.drawable.bg_read_3};
    }
...
//        int resId = mPortraitBGs[mBGSizeIndex][newNo];
    ...
    public Bitmap createPageBgBipmap(){
        Bitmap bitmap = BitmapFactory.decodeResource(mResources, R.drawable.bg_read_3);
